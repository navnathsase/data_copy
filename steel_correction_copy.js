if (document.URL.includes('efasttech.in')) {
     let storArray = {
          pan_number: document.getElementById('pan_number')?.innerText.trim(),
          ...
          dispatch_state: document.getElementById('dispatch_state')?.innerText.trim(),
     ...
     chrome.storage.local.set({ 'steelCorrectionData': storArray }, function () {
